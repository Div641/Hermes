            ...
            <form onSubmit={submitForm} className="space-y-4">
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-[#091B63] hover:bg-[#06144b] dark:bg-blue-600 dark:hover:bg-blue-500 disabled:bg-gray-500 text-white text-base sm:text-lg font-semibold py-3 rounded-xl transition duration-300 shadow-md active:scale-[0.99] mt-2"
                >
